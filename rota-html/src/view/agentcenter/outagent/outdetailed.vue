  ...
  <div>
    <div class="title">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item><span  class="large">代理商详细信息</span> </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="my-title">
      <h2>NA泛娱乐</h2>
    </div>
    <outdetailform></outdetailform>
  </div>
</template>

<script>
import Outdetailform from '@/components/agentcenter/outagent/outdetailform'
export default {
  components: {
    Outdetailform
  }
